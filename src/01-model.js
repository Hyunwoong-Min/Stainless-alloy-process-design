/* ══════════════════════════════════════════════════════════════
   1. 원소 · 공정 항목 정의
   ══════════════════════════════════════════════════════════════ */
/* 전역 입력 허용범위 — 스테인리스 전 계열(201~310S, 409~447, 403~440C)을 담는다.
   계열별 실제 설계공간은 FAM_RANGE 가 다시 좁힌다. */
const EL = [
  {k:'C', n:'C',  s:0.005, d:3, min:0.003, max:1.20},
  {k:'Si',n:'Si', s:0.01,  d:2, min:0.05,  max:2.50},
  {k:'Mn',n:'Mn', s:0.01,  d:2, min:0.10,  max:10.0},
  {k:'P', n:'P',  s:0.001, d:3, min:0.005, max:0.050},
  {k:'S', n:'S',  s:0.0005,d:4, min:0.0002,max:0.035},
  {k:'Cr',n:'Cr', s:0.05,  d:2, min:10.0,  max:30.0},
  {k:'Ni',n:'Ni', s:0.05,  d:2, min:0.00,  max:24.0},
  {k:'Mo',n:'Mo', s:0.01,  d:2, min:0.00,  max:5.00},
  {k:'Ti',n:'Ti', s:0.005, d:3, min:0.000, max:1.20},
  {k:'Nb',n:'Nb', s:0.005, d:3, min:0.000, max:1.20},
  {k:'Cu',n:'Cu', s:0.01,  d:2, min:0.00,  max:4.50},
  {k:'N', n:'N',  s:0.005, d:3, min:0.003, max:0.400},
  {k:'Al',n:'Al', s:0.001, d:3, min:0.001, max:0.200}
];
const PR = [
...
/* ══════════════════════════════════════════════════════════════
   1-b. 신강종 설계공간 — 기본 강종 규격을 벗어나 계열 전체를 쓴다
   ══════════════════════════════════════════════════════════════ */
/* 각 계열이 상용적으로 존재하는 성분 범위. 여기를 벗어나면 모델의
   보정 근거(문헌 실측)가 없으므로 상한으로 삼는다. */
const FAM_RANGE={
  austenitic:{                                   // 201 ~ 310S ~ 317L 영역
    C:[0.005,0.12],Si:[0.10,2.00],Mn:[0.20,8.00],P:[0.010,0.045],S:[0.0002,0.030],
    Cr:[16.0,26.0],Ni:[6.0,22.0],Mo:[0,4.00],Ti:[0,0.70],Nb:[0,1.00],
    Cu:[0,4.00],N:[0.010,0.350],Al:[0.001,0.100]},
  ferritic:{                                     // 409 ~ 430 ~ 444 ~ 447 영역
  ...
  martensitic:{                                  // 403 ~ 410 ~ 420 ~ 431 ~ 440 영역
    ...
    Cu:[0,1.00],N:[0.005,0.100],Al:[0.001,0.060]}
};
/* 공정 조업창도 계열 단위로 넓힌다 (설비 한계는 PR 의 min/max 가 여전히 상한) */
const FAM_PK={
  austenitic:{rhfT:[1180,1300],rdt:[980,1150],fdt:[850,1030],ct:[450,860],hrT:[2.0,8.0],
...
/* 설계 결과가 어느 상용 강종에 가까운지 판정하기 위한 참조표 (대표 조성) */
const REF_GRADES=[
  {n:'201',f:'austenitic',C:0.08,Cr:16.5,Ni:4.5,Mo:0,Mn:6.5,N:0.15,Ti:0,Nb:0,Cu:0.5},
  {n:'301',f:'austenitic',C:0.10,Cr:17.0,Ni:7.0,Mo:0,Mn:1.0,N:0.05,Ti:0,Nb:0,Cu:0.2},
  {n:'304',f:'austenitic',C:0.05,Cr:18.2,Ni:8.3,Mo:0.2,Mn:1.1,N:0.045,Ti:0,Nb:0,Cu:0.35},
  {n:'304L',f:'austenitic',C:0.020,Cr:18.3,Ni:8.6,Mo:0.2,Mn:1.1,N:0.045,Ti:0,Nb:0,Cu:0.35},
  {n:'305',f:'austenitic',C:0.05,Cr:18.0,Ni:11.5,Mo:0.2,Mn:1.0,N:0.03,Ti:0,Nb:0,Cu:0.3},
  {n:'309S',f:'austenitic',C:0.05,Cr:23.0,Ni:13.5,Mo:0.2,Mn:1.5,N:0.05,Ti:0,Nb:0,Cu:0.3},
  {n:'310S',f:'austenitic',C:0.05,Cr:25.0,Ni:20.0,Mo:0.2,Mn:1.5,N:0.05,Ti:0,Nb:0,Cu:0.3},
  {n:'316',f:'austenitic',C:0.05,Cr:17.0,Ni:10.5,Mo:2.1,Mn:1.2,N:0.05,Ti:0,Nb:0,Cu:0.4},
  {n:'316L',f:'austenitic',C:0.020,Cr:17.2,Ni:10.5,Mo:2.1,Mn:1.2,N:0.05,Ti:0,Nb:0,Cu:0.4},
  {n:'317L',f:'austenitic',C:0.020,Cr:18.5,Ni:13.0,Mo:3.3,Mn:1.3,N:0.06,Ti:0,Nb:0,Cu:0.4},
  {n:'321',f:'austenitic',C:0.05,Cr:17.5,Ni:9.5,Mo:0.2,Mn:1.2,N:0.02,Ti:0.35,Nb:0,Cu:0.3},
  {n:'347',f:'austenitic',C:0.05,Cr:17.5,Ni:10.0,Mo:0.2,Mn:1.2,N:0.03,Ti:0,Nb:0.60,Cu:0.3},
  {n:'409',f:'ferritic',C:0.015,Cr:11.2,Ni:0.2,Mo:0.02,Mn:0.4,N:0.012,Ti:0.25,Nb:0,Cu:0.1},
  {n:'430',f:'ferritic',C:0.045,Cr:16.3,Ni:0.2,Mo:0.02,Mn:0.4,N:0.040,Ti:0,Nb:0,Cu:0.08},
  {n:'434',f:'ferritic',C:0.045,Cr:16.8,Ni:0.2,Mo:1.0,Mn:0.4,N:0.040,Ti:0,Nb:0,Cu:0.1},
  {n:'436',f:'ferritic',C:0.020,Cr:17.0,Ni:0.2,Mo:1.0,Mn:0.4,N:0.020,Ti:0,Nb:0.45,Cu:0.1},
  {n:'439',f:'ferritic',C:0.012,Cr:17.4,Ni:0.25,Mo:0.02,Mn:0.3,N:0.012,Ti:0.31,Nb:0,Cu:0.08},
  ...
  {n:'431',f:'martensitic',C:0.15,Cr:16.0,Ni:2.0,Mo:0.1,Mn:0.6,N:0.040,Ti:0,Nb:0,Cu:0.2},
  {n:'440A',f:'martensitic',C:0.68,Cr:17.0,Ni:0.4,Mo:0.4,Mn:0.6,N:0.040,Ti:0,Nb:0,Cu:0.1},
  {n:'440C',f:'martensitic',C:1.05,Cr:17.0,Ni:0.4,Mo:0.5,Mn:0.6,N:0.040,Ti:0,Nb:0,Cu:0.1}
];
/* 정규화 거리 — 원소별 실무 허용폭으로 나눠 비교 */
const REF_W={C:0.03,Cr:1.0,Ni:1.0,Mo:0.3,Mn:0.5,N:0.02,Ti:0.10,Nb:0.10,Cu:0.3};
function nearestGrade(fam,c){
  const list=REF_GRADES.filter(g=>g.f===fam);
  let best=null;
  list.forEach(g=>{
    let d=0,n=0;
    Object.keys(REF_W).forEach(e=>{ d+=Math.pow((c[e]-g[e])/REF_W[e],2); n++; });
    d=Math.sqrt(d/n);
    if(!best||d<best.d) best={g:g.n,d};
  });
